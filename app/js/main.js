...
(function () {
  ...
  function registerWindows() {
    ...
    const defs = [
      ...
      { id: 'occultation-plan', title: 'Occultation Plan', x: Math.round(W * 0.20), y: Math.round(H * 0.12),
        w: 560, h: 360, minW: 480, minH: 280, open: false,
        build: (b, w) => SAT.occultation.planUI.init(b, w) },
      { id: 'occultation-events', title: 'Occultation Events', x: Math.round(W * 0.24), y: Math.round(H * 0.18),
        w: 760, h: 360, minW: 560, minH: 260, open: false,
        build: (b, w) => SAT.occultation.eventsUI.init(b, w) },
      { id: 'occultation-chart', title: 'Occultation Chart', x: Math.round(W * 0.30), y: Math.round(H * 0.24),
        w: 520, h: 470, minW: 360, minH: 320, open: false,
        build: (b, w) => SAT.occultation.chartUI.init(b, w) },
